...
- The application runs pending Goose migrations on startup, so schema changes are applied during deploy as long as the service can reach the Neon database.
